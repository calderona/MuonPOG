...
config.General.requestName = 'SingleMuonRun2016C_PromptReco_Run275782'
...
config.JobType.pyCfgParams = ['globalTag=80X_dataRun2_Prompt_v9',
                              'ntupleName=muonPOGNtuple_SingleMuonRun2016C_PromptReco.root',
                              'nEvents=-1',
                              'runOnMC=False',
                              'hltPathFilter=all',
                              'minMuPt=10.0',
