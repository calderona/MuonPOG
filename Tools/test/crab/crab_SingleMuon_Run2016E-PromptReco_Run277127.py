...
config.General.requestName = 'SingleMuonRun2016E_PromptReco_Run277127'
...
config.JobType.pyCfgParams = ['globalTag=80X_dataRun2_Prompt_v9',
                              'ntupleName=muonPOGNtuple_SingleMuonRun2016E_PromptReco.root',
                              'nEvents=-1',
                              'runOnMC=False',
                              'hltPathFilter=all',
                              'minMuPt=10.0',
...
config.Data.inputDataset = '/SingleMuon/Run2016E-PromptRecov2/AOD'

config.Data.runRange = '277127'
