...
config.General.requestName = 'MuOnia_Prompt_v2_' + runRange 
...
config.Data.inputDataset = '/MuOnia/Run2016B-PromptReco-v2/AOD'
...
config.Data.outputDatasetTag = 'MuOnia_Prompt_v2_' + runRange
